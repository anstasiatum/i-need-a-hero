...
public class PirateFeatureTest {
    ...
    void addSetShipsPassageFeature() {
        ...
        Response actualResponse = setPirateFeature("ship's passage", dndCharacter);
    ...
    void addBadReputationPassageFeature() {
        ...
        Response actualResponse = setPirateFeature("bad reputation", dndCharacter);
    ...
    void testInvalidInput() {
        ...
        Response actualResponse = setPirateFeature("test", dndCharacter);
