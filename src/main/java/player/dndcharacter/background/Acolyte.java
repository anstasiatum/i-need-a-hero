...
public class Acolyte extends Background {
    ...
    public void modifyByBackground(DndCharacter dndCharacter) {
        ...
        dndCharacter.setEquipment(dndCharacter.getEquipment() + "A holy symbol (a gift to you when you entered the priesthood), 5 sticks of incense, vestments, a set of common clothes, and a pouch containing 15 gp.");
